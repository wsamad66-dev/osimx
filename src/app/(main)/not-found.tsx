...
export default function NotFound() {
  return (
    <>
      ...
      `}</style>
      <div className="fixed inset-0 bg-gradient-to-br from-[#26a5de] to-[#232d6e] flex flex-col z-[9999]">
        {/* Main Content */}
        <main className="flex-1 flex items-center justify-between gap-10 md:gap-20 max-w-7xl mx-auto w-full flex-col md:flex-row py-12 px-8 md:px-16">
            ...
            >
              <Image
                ...
                priority
                placeholder="blur"
                blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mN8/Oj5fwAJBQO0a6zqGAAAAABJRU5ErkJggg=="
              />
