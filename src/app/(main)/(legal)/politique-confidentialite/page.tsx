...
export default function PolitiqueConfidentialitePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-primary-600 to-blue-700 text-white py-16 sm:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <PDFExportButton pageTitle="Politique de Confidentialité" className="bg-white text-primary-600 hover:bg-blue-50" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Introduction */}
          <div className="bg-blue-50 border-l-4 border-primary-600 p-6 rounded-r-lg mb-12">
            <div className="flex items-start gap-4">
              <AlertTriangle className="w-6 h-6 text-primary-600 flex-shrink-0 mt-1" />
              <div>
                <h2 className="text-lg font-semibold text-navy-900 mb-2">Engagement RGPD</h2>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
              ...
              <div className="space-y-3 bg-gray-50 rounded-lg p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-navy-900">L'Étudiant Étranger SARL</p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-gray-700">
                      ...
                      <a href="mailto:privacy@letudiantetranger.com" className="text-primary-600 hover:text-primary-700 underline">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-primary-600 pl-4">
                  <h3 className="font-semibold text-navy-900 mb-2">📞 Gestion de votre demande</h3>
                ...
                <div className="border-l-4 border-green-600 pl-4">
                  <h3 className="font-semibold text-navy-900 mb-2">📊 Amélioration de nos services</h3>
                  <p className="text-gray-700 text-sm">
                ...
                <div className="border-l-4 border-orange-600 pl-4">
                  <h3 className="font-semibold text-navy-900 mb-2">🔒 Sécurité</h3>
                  <p className="text-gray-700 text-sm">
                ...
                <div className="border-l-4 border-purple-600 pl-4">
                  <h3 className="font-semibold text-navy-900 mb-2">📈 Statistiques</h3>
                  <p className="text-gray-700 text-sm">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
              <div className="space-y-4">
                <div className="bg-blue-50 rounded-lg p-4">
                  <p className="text-gray-700">
                    <span className="font-semibold text-navy-900">Consentement :</span> Pour l'envoi de communications marketing et newsletters.
                  </p>
                </div>
                
                <div className="bg-green-50 rounded-lg p-4">
                  <p className="text-gray-700">
                    <span className="font-semibold text-navy-900">Exécution du contrat :</span> Pour la fourniture de nos services d'accompagnement.
                  </p>
                </div>
                
                <div className="bg-purple-50 rounded-lg p-4">
                  <p className="text-gray-700">
                    <span className="font-semibold text-navy-900">Intérêt légitime :</span> Pour l'amélioration de nos services et la sécurité de la plateforme.
                  </p>
                </div>
                
                <div className="bg-orange-50 rounded-lg p-4">
                  <p className="text-gray-700">
                    <span className="font-semibold text-navy-900">Obligation légale :</span> Pour la conservation de certaines données requises par la loi.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 bg-gray-50 rounded-lg p-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-navy-900 mb-1">Données de contact et de projet</h3>
                    <p className="text-gray-700 text-sm">
                ...
                <div className="flex items-start gap-4 bg-gray-50 rounded-lg p-4">
                  <Calendar className="w-6 h-6 text-primary-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-navy-900 mb-1">Données de navigation</h3>
                    <p className="text-gray-700 text-sm">
                ...
                <div className="flex items-start gap-4 bg-gray-50 rounded-lg p-4">
                  <Calendar className="w-6 h-6 text-primary-600 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-navy-900 mb-1">Consentement marketing</h3>
                    <p className="text-gray-700 text-sm">
          ...
          <section className="mb-12">
            ...
            <div className="bg-gradient-to-br from-primary-50 to-blue-50 rounded-xl border-2 border-primary-200 p-6 sm:p-8 mb-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <h3 className="font-semibold text-navy-900 mb-2">✅ Droit d'accès</h3>
                  <p className="text-gray-700 text-sm">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <h3 className="font-semibold text-navy-900 mb-2">✏️ Droit de rectification</h3>
                  <p className="text-gray-700 text-sm">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <h3 className="font-semibold text-navy-900 mb-2">🗑️ Droit à l'effacement</h3>
                  <p className="text-gray-700 text-sm">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <h3 className="font-semibold text-navy-900 mb-2">⏸️ Droit à la limitation</h3>
                  <p className="text-gray-700 text-sm">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <h3 className="font-semibold text-navy-900 mb-2">🚫 Droit d'opposition</h3>
                  <p className="text-gray-700 text-sm">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <h3 className="font-semibold text-navy-900 mb-2">📦 Droit à la portabilité</h3>
                  <p className="text-gray-700 text-sm">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
              ...
              <div className="bg-primary-50 rounded-lg p-4 flex items-center gap-3">
                ...
                <a 
                  ...
                  className="text-primary-600 hover:text-primary-700 font-semibold text-lg underline"
                >
                  privacy@letudiantetranger.com
                </a>
              </div>
          ...
          <section className="mb-12">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded-r-lg">
                <h3 className="font-semibold text-navy-900 mb-2">Gestion de vos cookies</h3>
                <p className="text-gray-700 text-sm mb-3">
          ...
          <section className="mb-12">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
              <p className="text-gray-700 mb-6">
                Vos données personnelles ne sont <span className="font-semibold text-navy-900">jamais vendues</span> à des tiers. Elles peuvent être partagées uniquement dans les cas suivants :
              </p>

              <div className="space-y-4">
                <div className="border-l-4 border-green-600 pl-4 bg-green-50 p-4 rounded-r-lg">
                  <h3 className="font-semibold text-navy-900 mb-2">✅ Prestataires de services</h3>
                ...
                <div className="border-l-4 border-blue-600 pl-4 bg-blue-50 p-4 rounded-r-lg">
                  <h3 className="font-semibold text-navy-900 mb-2">⚖️ Obligations légales</h3>
                  <p className="text-gray-700 text-sm">
                ...
                <div className="border-l-4 border-orange-600 pl-4 bg-orange-50 p-4 rounded-r-lg">
                  <h3 className="font-semibold text-navy-900 mb-2">🌍 Transferts hors UE</h3>
                  <p className="text-gray-700 text-sm mb-2">
          ...
          {/* Contact CTA */}
          <div className="bg-gradient-to-r from-primary-600 to-blue-700 rounded-2xl shadow-xl p-8 sm:p-10 text-white text-center">
            ...
            <a
              href="mailto:privacy@letudiantetranger.com"
              className="inline-flex items-center gap-2 bg-white text-primary-600 px-8 py-4 rounded-full font-semibold hover:bg-blue-50 transition-colors shadow-lg"
            >
