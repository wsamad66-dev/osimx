...
const fallbackData: NavigationContent = {
  ...
  menuItems: [
    { label: 'Accueil', link: '/', order: 1, _key: '1' },
    {
      ...
      hasDropdown: true,
      dropdownItems: [
        { label: 'Accompagnement Admission', link: '/services/admission', _key: 's1' },
        { label: 'Assistance Visa', link: '/services/visa', _key: 's2' },
        { label: 'Recherche Logement', link: '/services/logement', _key: 's3' },
        { label: 'Bourses d\'Études', link: '/services/bourses', _key: 's4' },
        { label: 'Préparation au Départ', link: '/services/preparation', _key: 's5' },
      ],
      order: 2,
      _key: '2',
    },
